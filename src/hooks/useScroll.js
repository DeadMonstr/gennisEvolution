...
/** * Hook to cache and restore scroll position. * @param key unique key for each route/page (e.g. "users-list") * @param element optional scrollable element (defaults to window) */
