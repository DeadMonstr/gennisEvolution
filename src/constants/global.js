...
<<<<<<< HEAD
export const BackUrlForDoc = `http://192.168.68.101:5000/`
export const BackUrl = `${BackUrlForDoc}api/`
export const ClassroomUrl = `http://localhost:3000/`
export const ClassroomUrlForDoc = "http://192.168.68.106:5001/"
=======
export const BackUrlForDoc = `http://192.168.68.109:5002/`
export const BackUrl = `${BackUrlForDoc}api/`
export const ClassroomUrl = `http://localhost:3000/`
export const ClassroomUrlForDoc = "http://192.168.68.109:5001/"
>>>>>>> origin/sardor
